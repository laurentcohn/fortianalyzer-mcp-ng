...
## [1.1.2-ng.1] - 2026-04-24

### Merged
- Integrated upstream `v1.1.2-beta`, including the `is_exact` fix for port analysis and its regression tests

### Fork
- Preserved fork-specific packaging, health reporting, dynamic mode fixes, and output safety behavior
